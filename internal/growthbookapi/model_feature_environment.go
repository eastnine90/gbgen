...
// checks if the FeatureEnvironment type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FeatureEnvironment{}
...
func NewFeatureEnvironment(defaultValue string, enabled bool, rules []FeatureRule) *FeatureEnvironment {
...
func (o *FeatureEnvironment) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varFeatureEnvironment)
