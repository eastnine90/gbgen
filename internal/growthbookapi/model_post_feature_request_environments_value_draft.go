...
// checks if the PostFeatureRequestEnvironmentsValueDraft type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostFeatureRequestEnvironmentsValueDraft{}
...
type PostFeatureRequestEnvironmentsValueDraft struct {
	...
	Rules []PostFeatureRequestEnvironmentsValueDraftRulesInner `json:"rules"`
}
...
func NewPostFeatureRequestEnvironmentsValueDraft(rules []PostFeatureRequestEnvironmentsValueDraftRulesInner) *PostFeatureRequestEnvironmentsValueDraft {
...
func (o *PostFeatureRequestEnvironmentsValueDraft) GetRules() []PostFeatureRequestEnvironmentsValueDraftRulesInner {
	if o == nil {
		var ret []PostFeatureRequestEnvironmentsValueDraftRulesInner
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *PostFeatureRequestEnvironmentsValueDraft) GetRulesOk() ([]PostFeatureRequestEnvironmentsValueDraftRulesInner, bool) {
	if o == nil {
		return nil, false
	}
	return o.Rules, true
...
func (o *PostFeatureRequestEnvironmentsValueDraft) SetRules(v []PostFeatureRequestEnvironmentsValueDraftRulesInner) {
	o.Rules = v
}
...
func (o *PostFeatureRequestEnvironmentsValueDraft) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varPostFeatureRequestEnvironmentsValueDraft)
