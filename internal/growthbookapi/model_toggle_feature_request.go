...
// checks if the ToggleFeatureRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ToggleFeatureRequest{}
...
func (o *ToggleFeatureRequest) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varToggleFeatureRequest)
