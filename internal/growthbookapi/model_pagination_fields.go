...
// checks if the PaginationFields type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginationFields{}
...
type PaginationFields struct {
	...
	NextOffset NullableInt32 `json:"nextOffset"`
...
func NewPaginationFields(count int32, hasMore bool, limit int32, nextOffset NullableInt32, offset int32, total int32) *PaginationFields {
...
func (o *PaginationFields) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varPaginationFields)
