...
// checks if the FeatureRevision type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FeatureRevision{}
...
func NewFeatureRevision(comment string, date time.Time, publishedBy string, version int32) *FeatureRevision {
...
func (o *FeatureRevision) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varFeatureRevision)
