...
// checks if the FeatureEnvironmentDraft type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FeatureEnvironmentDraft{}
...
func NewFeatureEnvironmentDraft(defaultValue string, enabled bool, rules []FeatureRule) *FeatureEnvironmentDraft {
...
func (o *FeatureEnvironmentDraft) GetRules() []FeatureRule {
	if o == nil {
		var ret []FeatureRule
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *FeatureEnvironmentDraft) GetRulesOk() ([]FeatureRule, bool) {
	if o == nil {
		return nil, false
	}
	return o.Rules, true
...
func (o *FeatureEnvironmentDraft) SetRules(v []FeatureRule) {
	o.Rules = v
}
...
func (o *FeatureEnvironmentDraft) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varFeatureEnvironmentDraft)
