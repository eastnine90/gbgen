...
// checks if the PostFeatureRequestEnvironmentsValue type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostFeatureRequestEnvironmentsValue{}
...
func NewPostFeatureRequestEnvironmentsValue(enabled bool, rules []PostFeatureRequestEnvironmentsValueDraftRulesInner) *PostFeatureRequestEnvironmentsValue {
...
func (o *PostFeatureRequestEnvironmentsValue) GetRules() []PostFeatureRequestEnvironmentsValueDraftRulesInner {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *PostFeatureRequestEnvironmentsValue) GetRulesOk() ([]PostFeatureRequestEnvironmentsValueDraftRulesInner, bool) {
	if o == nil {
		return nil, false
	}
	return o.Rules, true
...
func (o *PostFeatureRequestEnvironmentsValue) SetRules(v []PostFeatureRequestEnvironmentsValueDraftRulesInner) {
	o.Rules = v
}
...
func (o *PostFeatureRequestEnvironmentsValue) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varPostFeatureRequestEnvironmentsValue)
